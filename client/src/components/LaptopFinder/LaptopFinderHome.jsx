...
const LaptopFinder = ({laptopsArray, setStep,step, closeModal,nextStep,prevStep}) => {
  return (
    <>
    <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-[100] absolute outline-none focus:outline-none">
      <div className="relative w-full my-6 mx-auto max-w-screen-2xl">
        ...
        <div className="border-0 shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
          ...
          {/*body*/}
          <LaptopFinderBody laptopsArray={laptopsArray} nextStep={nextStep} prevStep={prevStep}/>
          {/*footer*/}
        </div>
      </div>
    </div>
