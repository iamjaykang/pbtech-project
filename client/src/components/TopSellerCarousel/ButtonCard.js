    ...
    return (
        <div className={topSellerStyles.card}>
            ...
            <div className={topSellerStyles.text}>{sect.text}</div>
                <img src={sect.image} className={ topSellerStyles.image} alt=''/>
                <div className={ topSellerStyles.starSection}>
                    <img src={sect.star} className={ topSellerStyles.star} alt=''/>
                    <img src={sect.star2} className={ topSellerStyles.star}alt=''/>
                    <img src={sect.star3} className={ topSellerStyles.star}alt=''/>
                    <img src={sect.star4} className={ topSellerStyles.star}alt=''/>
                    <img src={sect.star5} className={ topSellerStyles.star}alt=''/>
                    </div>
